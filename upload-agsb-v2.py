...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "jhjy"         # 用户名
UUID = "df1f56cd-73da-411a-bacf-9cdd5a013214"                     # UUID，留空则自动生成
PORT = 23246                   # Vmess端口，留空或0则自动生成
DOMAIN = "stre.xd001.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMmVlNGQ2ZGEzY2UzOGIyNjgzODYyMjUxOTA5MTQ4NDAiLCJ0IjoiODU5ZGRlNTQtMmNiMi00Y2NmLWFjYmMtZDZkOTNhMjQwMGNjIiwicyI6Ik5tRm1OamM1WW1VdE56STJZeTAwT0ROakxUa3lNelV0TVdVMk1tRTBPV1ppTm1ZeiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
